...
const char* password = "cobrahotspot";

// ThingSpeak settings
const char* server = "http://api.thingspeak.com";
const char* readApiKey = "1XQKT69AKDD5J9P9";   // Replace with your ThingSpeak Read API Key
const int channelID = 1896657;                 // Replace with your ThingSpeak Channel ID
