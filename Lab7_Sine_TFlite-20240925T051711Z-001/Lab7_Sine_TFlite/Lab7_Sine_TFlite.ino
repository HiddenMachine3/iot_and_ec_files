...
const int kInferencesPerCycle = 20;  // Number of samples in one cycle 
...
void inferenceTask(void * parameter) {
  ...
  while(1){
    inferenceEngine();
    delay(100);    // Delay by 100 msec between two predictions to view the plot on the screen
  }
